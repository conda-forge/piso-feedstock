...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/piso-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14132&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/piso-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `piso` can be installed with:

```
conda install piso
```

It is possible to list all of the versions of `piso` available on your platform with:
